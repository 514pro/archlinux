...
myWorkspaces :: [String]
myWorkspaces = clickable . (map xmobarEscape) $ ["dev","www","sys","doc","vbox","chat","mus","vid","gfx","fun"]
    where
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- SUPER + FUNCTION KEYS
    ...
    , ((modMask, xK_i), spawn $ "alacritty" )
      , ((modMask, xK_u), spawn $ "geogebra" )
	...
	, ((modMask, xK_l), spawn $ "xfce4-screenshooter")
...
main = do
        ...
        , ppCurrent = xmobarColor myCurrentWSColor "" . wrap "[ " " ]" -- Current workspcae in xmobar
        , ppVisible = xmobarColor myVisibleWSColor "" . wrap """"   -- Visible but not current workspcae
        , ppHidden = xmobarColor "#85AAFF" "" . wrap "*" ""                -- Hidden workspcae in xmobar
